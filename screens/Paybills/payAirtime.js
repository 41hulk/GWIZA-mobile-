...
export default class payAirtime extends Component {
    constructor(props) {
    super(props);
    this.state = {
      selected2: undefined
            ...
            <View style={{margin:10}}>
              <Item picker >
                ...
                >
                  ...
                  <Picker.Item label="TIGO" value="key1" />
                  <Picker.Item label="AIRTEL" value="key2" />
                </Picker>
              </Item>
            </View>
            <Item stackedLabel>
                <Label style={styles.inputLabel}>Number</Label>
