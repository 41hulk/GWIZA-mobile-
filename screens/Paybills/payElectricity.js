...
export default class payElectricity extends Component {
    constructor(props) {
    super(props);
    this.state = {
      selected2: undefined
    ...
    return (
      <Container>
        <Content>
          <Form>
            <Item stackedLabel>
                <Label style={styles.inputLabel}>CashPower Number</Label>
                <Input style={{ color: "#000" }} keyboardType = 'numeric'/>
            </Item>
            <Item disabled stackedLabel>
                <Label style={styles.inputLabel}>CashPower Name</Label>
                <Input disabled value={'Mukankusi Jeanette'} style={{ color: "#000" }} keyboardType = 'numeric'/>
            </Item>
            <Item stackedLabel>
                <Label style={styles.inputLabel}>Amount</Label>
                <Input style={{ color: "#000" }} keyboardType = 'numeric'/>
            </Item>
            <Button block bordered light style={styles.saveBtn} onPress={() => this.props.navigation.navigate('Receipt')}>
