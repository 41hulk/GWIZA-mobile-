    ...
    return (
      <Container>
        ...
        <Form style={styles.form}>
            ...
            <Item stackedLabel>
                <Label style={styles.inputLabel}>Loan Title</Label>
            ...
            <Button block bordered light style={styles.saveBtn} onPress={() => alert('Thanks You, Wait for Approval')}>
                <Text style = {styles.LoginText} autoCapitalize="characters"> Request </Text>
            </Button>
        </Form>
        </Content>
        <NavBottom/>
